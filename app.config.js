module.exports = {
    expo: {
      ...
      extra: {
        ...
        FIREBASE_MESSAGING_SENDER_ID: process.env.FIREBASE_MESSAGING_SENDER_ID || "${FIREBASE_MESSAGING_SENDER_ID}",
        ...
        UNSPLASH_ACCESS_KEY: process.env.EXPO_PUBLIC_UNSPLASH_ACCESS_KEY || "${EXPO_PUBLIC_UNSPLASH_ACCESS_KEY}"
      }
    }
  };
